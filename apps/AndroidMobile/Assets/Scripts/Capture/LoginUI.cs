                                ...
                                children = Props.List(
                                            ...
                                            children = Props.List(
                                                LabeledButton(
                                                    new LabeledButtonProps()
                                                    {
                                                        ...
                                                        onClick = () =>
                                                            App.state.loginRequested.ExecuteSetOrDelay(true),
                                                    }
                                                )
                                            ),
                                        }
                                    ...
                                    Text(
                                        new TextProps()
                                        {
                                            ...
                                            {
                                                active = App
                                                    .state.authError.AsObservable()
                                                    .SelectDynamic(x => !string.IsNullOrEmpty(x)),
                                            },
