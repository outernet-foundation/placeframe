...
namespace Placeframe.Client
{
    public static partial class UIElements
    {
        ...
        public static IControl TabbedMenu(TabbedMenuProps props = default)
        {
            ...
            props.selectedBackgroundStyle.color =
                props.selectedBackgroundStyle.color ?? Props.Value(elements.foregroundColor);
            props.selectedBackgroundStyle.pixelsPerUnitMultiplier =
                props.selectedBackgroundStyle.pixelsPerUnitMultiplier ?? Props.Value(1.3f);
            props.selectedBackgroundStyle.imageType =
                props.selectedBackgroundStyle.imageType ?? Props.Value(UnityEngine.UI.Image.Type.Sliced);
            props.selectedBackgroundStyle.fillCenter = props.selectedBackgroundStyle.fillCenter ?? Props.Value(true);
            props.selectedBackgroundStyle.raycastTarget =
                props.selectedBackgroundStyle.raycastTarget ?? Props.Value(true);

            props.deselectedBackgroundStyle.raycastTarget =
                props.deselectedBackgroundStyle.raycastTarget ?? Props.Value(true);
            ...
            props.backgroundStyle.pixelsPerUnitMultiplier =
                props.backgroundStyle.pixelsPerUnitMultiplier ?? Props.Value(1f);
            props.backgroundStyle.imageType =
                props.backgroundStyle.imageType ?? Props.Value(UnityEngine.UI.Image.Type.Sliced);
                            ...
                            new()
                            {
                                ...
                                columns = props.tabs.CreateDynamic(tabLabel =>
                                {
                                    ...
                                    var currentBackgroundStyle = Observables.Combine(
                                        ...
                                        (index, selectedIndex) =>
                                            index == selectedIndex
                                                ? props.selectedBackgroundStyle
                                                : props.deselectedBackgroundStyle
                                    );
                                    ...
                                    return Button(
                                        new()
                                        {
                                            ...
                                            {
                                                bindings = Props.List(
                                                    tabIndex.Subscribe(x => currentTabIndex = x.currentValue)
                                                ),
                                            },
                                            ...
                                            background =
                                            {
                                                ...
                                                style =
                                                {
                                                    ...
                                                    fillCenter = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.fillCenter
                                                    ),
                                                    pixelsPerUnitMultiplier = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.pixelsPerUnitMultiplier
                                                    ),
                                                    raycastTarget = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.raycastTarget
                                                    ),
                                                    raycastPadding = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.raycastPadding
                                                    ),
                                                    useSpriteMesh = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.useSpriteMesh
                                                    ),
                                                    preserveAspect = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.preserveAspect
                                                    ),
                                                    fillOrigin = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.fillOrigin
                                                    ),
                                                    fillMethod = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.fillMethod
                                                    ),
                                                    fillAmount = currentBackgroundStyle.SelectDynamic(x =>
                                                        x.fillAmount
                                                    ),
                                                },
                                            },
                                            content = Props.List(
                                                Text(
                                                    new TextProps()
                                                    {
                                                        ...
                                                        {
                                                            verticalAlignment = Props.Value(
                                                                TMPro.VerticalAlignmentOptions.Capline
                                                            ),
                                                            horizontalAlignment = Props.Value(
                                                                TMPro.HorizontalAlignmentOptions.Center
                                                            ),
                                                        },
                                                    }
                                                )
