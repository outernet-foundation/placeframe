                            ...
                            new()
                            {
                                ...
                                children = Props.List(
                                    ...
                                    LabeledButton(
                                        ...
                                        {
                                            label = App
                                                .state.captureMode.AsObservable()
                                                .SelectDynamic(x => x == DeviceType.ARFoundation ? "Local" : "Zed"),
                                            onClick = () =>
                                                App.state.captureMode.ExecuteSetOrDelay(
                                                    App.state.captureMode.value == DeviceType.ARFoundation
                                                        ? DeviceType.Zed
                                                        : DeviceType.ARFoundation
                                                ),
                                            layout = new()
                                            {
                                                sizeDelta = Props.Value(new Vector2(255, 75)),
                                    ...
                                    Toggle(
                                        prefab: elements.recordButton,
                                        props: new ToggleProps()
                                        {
                                            value = App
                                                .state.captureStatus.AsObservable()
                                                .SelectDynamic(x =>
                                                    x == CaptureStatus.Capturing || x == CaptureStatus.Starting
                                                ),
                                            interactable = App
                                                .state.captureStatus.AsObservable()
                                                .SelectDynamic(x =>
                                                    x == CaptureStatus.Idle || x == CaptureStatus.Capturing
                                                ),
                                            layout = new()
                                            {
                                            ...
                                            onValueChanged = isOn =>
                                            {
                                                if (isOn)
                                                {
                                                    if (App.state.captureStatus.value == CaptureStatus.Idle)
                                                        App.state.captureStatus.ExecuteSetOrDelay(
                                                ...
                                                children = Props.List(
                                                    Image(
                                                        new()
                                                        {
                                                            ...
                                                            layout = Utility.FillParentProps(
                                                                new() { ignoreLayout = Props.Value(true) }
                                                            ),
                                                        }
                                                    ),
                                                                ...
                                                                TightRowsWideColumns(
                                                                    new()
                                                                    {
                                                                        layout = Utility.FillParentProps(
                                                                            new()
                                                                            {
                                                                                fitContentVertical = Props.Value(
                                                                                    ContentSizeFitter
                                                                                        .FitMode
                                                                                        .PreferredSize
                                                                                ),
                                    ...
                                    new()
                                    {
                                        ...
                                        children = Props.List(
                                            ...
                                            Text(
                                                new()
                                                {
                                                    value = target.SelectDynamic(x =>
                                                        x == null ? "--" : getValue(x).ToString()
                                                    ),
                                                    layout = new() { flexibleWidth = Props.Value(true) },
                                                    style = new()
                                                    {
                                                        outlineWidth = Props.Value(.15f),
                                                        horizontalAlignment = Props.Value(
                                                            TMPro.HorizontalAlignmentOptions.Right
                                                        ),
                        ...
                        Control(
                            ...
                            new()
                            {
                                ...
                                children = Props.List(
                                    ...
                                    LabeledButton(
                                        new LabeledButtonProps()
                                        {
                                            label = App
                                                .state.captures.AsObservable()
                                                .WhereDynamic(x =>
                                                    x.Value.localizationMapId.AsObservable()
                                                        .SelectDynamic(x => x != Guid.Empty)
                                                )
                                                .ToDictionaryDynamic(
                                                ...
                                                .SelectDynamic(x =>
                                                    x.keyPresent ? x.value.name.AsObservable() : Props.Value("Maps")
                                                ),
                                            ...
                                            onClick = () =>
                                                selectValidationTargetDialog = SelectValidationTargetDialog(
                                                    new()
                                                    {
                                    ...
                                    Toggle(
                                        prefab: elements.playButton,
                                        props: new ToggleProps()
                                        {
                                            value = App.state.localizing.AsObservable(),
                                            interactable = App
                                                .state.mapForLocalization.AsObservable()
                                                .SelectDynamic(x => x != Guid.Empty),
                                                                ...
                                                                TightRowsWideColumns(
                                                                    new()
                                                                    {
                                                                        ...
                                                                        layout = Utility.FillParentProps(
                                                                            ...
                                                                            {
                                                                                pivot = Props.Value(new Vector2(0, 1)),
                                                                                anchorMin = Props.Value(
                                                                                    new Vector2(0, 1)
                                                                                ),
                                                                                anchorMax = Props.Value(
                                                                                    new Vector2(1, 1)
                                                                                ),
                                                                                offsetMin = Props.Value(
                                                                                    new Vector2(0, 0)
                                                                                ),
                                                                                offsetMax = Props.Value(
                                                                                    new Vector2(0, 0)
                                                                                ),
                                                                                fitContentVertical = Props.Value(
                                                                                    ContentSizeFitter
                                                                                ...
                                                                                LabeledButton(
                                                                                    new LabeledButtonProps()
                                                                                    {
                                                                                        label =
                                                                                            x.Value.name.AsObservable(),
                                                                                        onClick = () =>
                                                                                            props.onValidationTargetSelected?.Invoke(
                                                                                                x.Value
                                                                                                    .localizationMapId
                                                                                                    .value
                                                                                            ),
                                            ...
                                            new()
                                            {
                                                ...
                                                children = Props.List(
                                                    Title(
                                                        new TextProps()
                                                        {
                                                            value = Props.Value("Reconstruction Options"),
                                                        }
                                                    ),
                                                    ScrollRect(
                                                        new ScrollRectProps()
                                                            ...
                                                            content = Props.Value(
                                                                VerticalLayout(
                                                                    new()
                                                                    {
                                                                        ...
                                                                        children = Props.List(
                                                                            ObjectFieldInspectors(props.options)
                                                                        ),
                                                                    }
                                                                )
                                                            ),
                                                                ...
                                                                VerticalLayout(
                                                                    new()
                                                                    {
                                                                        ...
                                                                        children = Props.List(
                                                                                ...
                                                                                new LabeledControlProps()
                                                                                {
                                                                                    ...
                                                                                    control = InputField(
                                                                                        new InputFieldProps()
                                                                                        {
                                                                                            ...
                                                                                            value =
                                                                                                capture.name.AsObservable(),
                                                                                            placeholderValue =
                                                                                                Props.Value(
                                                                                                    capture.id.ToString()
                                                                                                ),
                                                                                            onEndEdit = x =>
                                                                                                capture.name.ExecuteSetOrDelay(
                                                                                                    x
                                                                                                ),
                                                                                        }
                                                                                    ),
                                                                                        ...
                                                                                        LabeledButton(
                                                                                            new LabeledButtonProps()
                                                                                            {
                                                                                                    ...
                                                                                                    Observables.Combine(
                                                                                                        ...
                                                                                                        (
                                                                                                            ...
                                                                                                            && (
                                                                                                                ...
                                                                                                                || status
                                                                                                                    == CaptureUploadStatus.Uploaded
                                                                                                                || status
                                                                                                                    == CaptureUploadStatus.MapCreated
                                                                                                                || status
                                                                                                ...
                                                                                                onClick = () =>
                                                                                                {
                                                                                                    ...
                                                                                                    {
                                                                                                        CaptureManager.DeleteCapture(
                                                                                                            capture.id
                                                                                                        );
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        ZedCaptureController
                                                                                                            .DeleteCapture(
                                                                                                                capture.id
                                                                                                            )
                                                                                                            .Forget();
                                                                                                    ...
                                                                                                    {
                                                                                                        App.state.captures.ExecuteRemoveOrDelay(
                                                                                                            capture.id
                                                                                                        );
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        capture.hasLocalFiles.ExecuteSetOrDelay(
                                                                                                            false
                                                                                                        );
                                                                                                    }
                                                                                                },
                                                                                                ...
                                                                                                label = capture
                                                                                                    ...
                                                                                                    .SelectDynamic(x =>
                                                                                                        x switch
                                                                                                        {
                                                                                                            CaptureUploadStatus.NotUploaded =>
                                                                                                                "Upload",
                                                                                                            CaptureUploadStatus.UploadRequested =>
                                                                                                                "Initializing",
                                                                                                            CaptureUploadStatus.Initializing =>
                                                                                                                "Initializing",
                                                                                                            CaptureUploadStatus.Uploading =>
                                                                                                                "Uploading",
                                                                                                            CaptureUploadStatus.ReconstructionNotStarted =>
                                                                                                                "Reconstruct",
                                                                                                            CaptureUploadStatus.ReconstructRequested =>
                                                                                                                "Constructing",
                                                                                                            CaptureUploadStatus.Reconstructing =>
                                                                                                                "Constructing",
                                                                                                            CaptureUploadStatus.Uploaded =>
                                                                                                                "Create Map",
                                                                                                            CaptureUploadStatus.CreateMapRequested =>
                                                                                                                "Create Map",
                                                                                                            CaptureUploadStatus.MapCreated =>
                                                                                                                "Map Created",
                                                                                                            CaptureUploadStatus.Failed =>
                                                                            ...
                                                                            ObjectInspector(
                                                                                new ObjectInspectorProps()
                                                                                {
                                                                                    target =
                                                                                        capture.manifest.value?.Options
                                                                            ...
                                                                            ObjectInspector(
                                                                                ...
                                                                                {
                                                                                    target =
                                                                                        capture.manifest.value?.Metrics
                                                                                        ?? new ReconstructionMetrics(),
                                                                                    foldout = new FoldoutProps()
                                                                                    {
                                                                                        label = new TextProps()
                                                                                        {
