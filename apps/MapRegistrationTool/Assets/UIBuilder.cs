...
namespace Outernet.MapRegistrationTool
{
    ...
    {
        public struct InspectorProps<T> where T : IObservableNode
        {
            public IValueObservable<string> label;
            public IValueObservable<LabelType> labelType;
            public IValueObservable<bool> interactable;
            public T node;
        }

        public static IControl NodeInspector(InspectorProps<IObservableNode> props)
        {
            if (props.node.HasAttribute<HideInInspectorUIAttribute>())
            {
                return null;
            }
            else if (props.node.TryGetAttribute(out InspectorTypeAttribute attribute))
            {
                throw new NotImplementedException();
            }
            else if (props.node is ObservableObject obj)
            {
                return ObjectInspector(new()
                {
                    label = props.label,
            ...
            else if (props.node is IObservableDictionary dict)
            {
                return DictionaryInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
            ...
            else if (props.node is IObservableList list)
            {
                return ListInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
            ...
            else if (props.node is IObservableSet set)
            {
                return SetInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
            ...
            else if (props.node is IObservablePrimitiveMap map)
            {
                return PrimitiveMapInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
            ...
            else if (props.node is IObservablePrimitiveArray array)
            {
                return PrimitiveArrayInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
            ...
            else if (props.node is IObservablePrimitive primitive)
            {
                return PrimitiveInspector(new()
                {
                    label = props.label,
                    labelType = props.labelType,
                    interactable = props.interactable,
        ...
        public static IControl DictionaryInspector(InspectorProps<IObservableDictionary> dictionary)
        {
            return default;
        }

        public static IControl ListInspector(InspectorProps<IObservableList> list)
        {
            return default;
        }

        public static IControl PrimitiveInspector(InspectorProps<IObservablePrimitive> primitive)
        {
            return default;
        }

        public static IControl PrimitiveMapInspector(InspectorProps<IObservablePrimitiveMap> primitive)
        {
            return default;
        }

        public static IControl SetInspector(InspectorProps<IObservableSet> set)
        {
            return default;
        }

        public static IControl PrimitiveArrayInspector(InspectorProps<IObservablePrimitiveArray> array)
        {
            return default;
        }

        public static IControl ObjectInspector(InspectorProps<ObservableObject> obj)
        {
            return default;
        }

        public static IControl DefaultInspector(InspectorProps<IObservableNode> node)
        {
            return default;
        }

        public class ECEFRotationInspector { }
        public class ECEFPositionInspector { }

        // public static IControl ECEFRotationInspector(InspectorProps<IObservableNode> node)
        // {
        //     return default;
        // }

        // public static IControl ECEFPositionInspector(InspectorProps<IObservableNode> node)
        // {
        //     return default;
        // }
    }
