...
namespace Placeframe.MapRegistrationTool
{
    public class UndoRedoManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            App.RegisterObserver(HandleContentLoadedChanged, App.state.locationContentLoaded);
        ...
        private void HandleEditorStateChanged(NodeChangeEventArgs args)
        {
        ...
        private class UndoNodeChangesAction : ObservableNodeAction<AppState>
        {
        ...
        private class RedoNodeChangesAction : ObservableNodeAction<AppState>
        {
