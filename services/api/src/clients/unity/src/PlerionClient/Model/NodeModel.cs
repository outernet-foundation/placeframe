...
namespace PlerionClient.Model
{
    ...
    public partial class NodeModel
    {
        ...
        public NodeModel(Guid id = default, string filename = default, DateTime createdAt = default, DateTime? uploadedAt = default)
        {
            this.Id = id;
            // to ensure "filename" is required (not null)
            if (filename == null)
            {
                throw new ArgumentNullException("filename is a required property for NodeModel and cannot be null");
            }
