...
if [[ "${RELOAD:-}" == "true" ]]; then
  ...
  UVICORN_ARGS+=( "--reload" "--reload-dir" "/app/docker/lease-server/src" "--reload-dir" "/app/packages/generated/python/datamodels/src" "--reload-dir" "/app/packages/python/common/src" "--reload-dir" "/app/packages/python/core/src" )
fi
