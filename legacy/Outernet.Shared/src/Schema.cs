...
namespace Outernet.Shared
{
    ...
    {
        static public LinkType LinkType(PlaceframeApiClient.Model.LinkType linkType)
        {
        ...
        static public PlaceframeApiClient.Model.LinkType LinkType(LinkType linkType)
        {
            return linkType switch
            {
        ...
        static public LabelType LabelType(PlaceframeApiClient.Model.LabelType labelType)
        {
        ...
        static public PlaceframeApiClient.Model.LabelType LabelType(LabelType labelType)
        {
            return labelType switch
            {
