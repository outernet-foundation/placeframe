...
class ReconstructionCreateWithOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["create", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReconstructionCreateWithOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReconstructionCreateWithOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "create": ReconstructionCreate.from_dict(obj["create"]) if obj.get("create") is not None else None,
