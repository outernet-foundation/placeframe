...
class CreateGraphResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GroupRead.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "nodes": [NodeRead.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
