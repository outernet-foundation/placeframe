...
class LocalizationMapBatchUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reconstruction_id", "id", "rotation_y", "position_x", "position_y", "position_z", "rotation_x", "rotation_z", "rotation_w", "color", "active", "lighting", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocalizationMapBatchUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocalizationMapBatchUpdate from a dict"""
        if obj is None:
            return None
