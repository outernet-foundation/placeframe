...
class CaptureSessionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "recorded_at", "size_bytes", "device_type", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaptureSessionRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaptureSessionRead from a dict"""
        if obj is None:
            return None
