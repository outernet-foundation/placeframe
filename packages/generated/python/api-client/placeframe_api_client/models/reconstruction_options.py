...
class ReconstructionOptions(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pair_vio_em_max_rotation_disagreement_deg": obj.get("pair_vio_em_max_rotation_disagreement_deg") if obj.get("pair_vio_em_max_rotation_disagreement_deg") is not None else 15.0,
            "pair_vio_em_max_translation_direction_deg": obj.get("pair_vio_em_max_translation_direction_deg") if obj.get("pair_vio_em_max_translation_direction_deg") is not None else 30.0,
