...
namespace PlaceframeApiClient.Model
{
    ...
    /// LayerRead
    /// </summary>
    [DataContract(Name = "LayerRead")]
    public partial class LayerRead
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LayerRead" /> class.
        /// </summary>
        ...
        public LayerRead(Guid id, DateTime createdAt, DateTime updatedAt, string name)
        {
            this.Id = id;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for LayerRead and cannot be null");
            }
            this.Name = name;
        }
