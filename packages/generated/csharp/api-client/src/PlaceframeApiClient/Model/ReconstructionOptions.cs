...
namespace PlaceframeApiClient.Model
{
    ...
    public partial class ReconstructionOptions
    {
        ...
        /// <param name="keyframeMinDistanceM">Minimum VIO-translation distance (meters) between successive kept keyframes; frames closer to the last kept frame than this are dropped before feature extraction. (default to 0.5D).</param>
        ...
        private double _KeyframeMinDistanceM = 0.5D;
