...
namespace PlaceframeApiClient.Model
{
    ...
    public partial class NodeCreate
    {
        ...
        public NodeCreate(double rotationZ, double labelWidth, double positionY, double positionZ, double rotationX, double rotationY, double rotationW, double labelHeight, double positionX, double labelScale, LinkType linkType, LabelType labelType, string link, string label, string name)
        {
            ...
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for NodeCreate and cannot be null");
            }
            this.Link = link;
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for NodeCreate and cannot be null");
            }
            this.Label = label;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for NodeCreate and cannot be null");
            }
            this.Name = name;
        }
